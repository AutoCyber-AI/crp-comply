...
export default function SignUpPage() {
  ...
  // Already authenticated users should not see the sign-up form.
  if (isSignedIn) {
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-2xl font-bold text-gray-900">Get started with CRP Comply</h1>
            <p className="mt-2 text-gray-600">Free tier includes 100 audited calls/mo and full EU AI Act risk classification.</p>
          </div>
          <SignUp
            routing="path"
            path="/sign-up"
